...
<!--右侧-->
	<div class="sdk_right">
		<div class="sdk_rightnav">当前位置 供应商管理  > 已审核供应商</div>
		<div class="sdk_righcon">
			...
			<table cellspacing="0" cellpadding="0" border="0" width="100%" class="sdk_table">
				...
				<tr>
					...
					<td><a href="/admin/supplier/edit?id=<?php echo $val['id'] ?>">编辑</a> | <a href="/admin/supplier/delete?id=<?php echo $val['id'] ?>">删除</a></td>
				</tr>
				<?php endforeach;?>
				<?php endif;?>
			</table>
