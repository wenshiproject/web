<!--右侧-->
	<div class="sdk_right">
		<div class="sdk_rightnav">当前位置：供应商管理 > 编辑供应商</div>
		<div class="sdk_righcon">
			...
			<table cellspacing="0" cellpadding="0" border="0" width="100%" class="sdk_table1">
              	<tr>
              		<td align="right" width="150"><lable class="colred">*</lable>供应商名称：</td><td><input type="text" class="sdk_zhucetext" size="15" name="name" value="<?php echo $rs['name'];?>" class="{required:true,messages:{required:'不能为空'}}"/>
              		</td>
              </tr>
               <tr>
              ...
              <tr>
              		<td align="right" width="150"><lable class="colred">*</lable>邮箱：</td><td><input type="text" class="sdk_zhucetext" size="15" name="email" value="<?php echo $rs['email'];?>" class="{required:true,messages:{required:'不能为空'}}" />
              		</td>
              </tr>
              <tr>
              ...
              <tr>
              		<td align="right" width="150"><lable class="colred">*</lable>联系QQ：</td><td><input type="text" class="sdk_zhucetext" name="qq" value="<?php echo $rs['qq'];?>" class="{required:true,messages:{required:'不能为空'}}"/>
              		</td>
              </tr>
			  <tr>
				<td align="right" width="150"> <lable class="colred">*</lable>营业执照：</td>
				<td>
