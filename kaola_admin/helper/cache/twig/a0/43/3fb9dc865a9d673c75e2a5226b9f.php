...
/* welcome/controller.tpl */
class __TwigTemplate_a0433fb9dc865a9d673c75e2a5226b9f extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        <a href=\"#controller-list\" class=\"block-heading\" data-toggle=\"collapse\">";
        // line 9
...
\$().ready(function(){
    \$(\"#generator\").click(function(){
        ...
        \$.post('";
        // line 44
        echo twig_escape_filter($this->env, site_url("welcome/controller_helper"), "html", null, true);
        echo "', {\"table\": \$(\"#table\").val(), \"controller\" : \$(\"#controller\").val(), \"model\" : \$(\"#model\").val()}, function(msg){
            \$(\"#result\").prepend(msg);
        });
...
";
    ...
    {
        return array (  80 => 44,  74 => 40,  71 => 39,  37 => 9,  34 => 8,  31 => 7,  26 => 5,);
    }
}
